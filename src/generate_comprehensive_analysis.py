...
Generates a detailed markdown report (archive/results/comprehensive_speed_accuracy_analysis.md)
comparing Therm-FM vs PACT across:
1. PACT SuperLU Physics Solver Baseline (CPU)
2. Therm-FM CPU Execution Latency & Speedup
3. Therm-FM GPU CUDA Execution Latency & Speedup
4. Downstream STA Timing Delay Shift (ps) and Timing Error / Timing Accuracy % vs PACT Ground-Truth
"""
...
def generate_report():
    ...
    report_md = r"""# Comprehensive Analysis: Therm-FM vs. PACT Ground-Truth Physics Solver
...
"""
    ...
    with open("archive/results/comprehensive_speed_accuracy_analysis.md", "w") as f:
        f.write(report_md)
        
    print("[Report Gen] Comprehensive analysis saved to archive/results/comprehensive_speed_accuracy_analysis.md")
