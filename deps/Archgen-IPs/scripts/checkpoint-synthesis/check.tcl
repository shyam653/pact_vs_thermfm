...
foreach instance [$block getInsts] {
    if {[[$instance getMaster] getName] eq "fakeram45_512x64"} { incr macros }
}
if {$macros != $::env(EXPECTED_SRAM_MACROS)} {
    error "Expected $::env(EXPECTED_SRAM_MACROS) SRAM macros, found $macros"
}
report_design_area
...
puts "Full $::env(CONFIG) ChipTop linked successfully"
exit
