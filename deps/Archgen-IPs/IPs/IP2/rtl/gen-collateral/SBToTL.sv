...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [119:0]    _GEN_0 = {io_addrIn[127:14], io_addrIn[13:8] ^ 6'h24};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [115:0]    _GEN_1 = {io_addrIn[127:14], ~(io_addrIn[13:12])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [114:0]    _GEN_2 = {io_addrIn[127:21], io_addrIn[20:17] ^ 4'h8, io_addrIn[15:12]};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [111:0]    _GEN_3 = {io_addrIn[127:26], io_addrIn[25:16] ^ 10'h200};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [115:0]    _GEN_4 = {io_addrIn[127:26], io_addrIn[25:12] ^ 14'h2010};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [111:0]    _GEN_5 = {io_addrIn[127:28], io_addrIn[27:16] ^ 12'h800};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [101:0]    _GEN_6 = {io_addrIn[127:28], ~(io_addrIn[27:26])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [115:0]    _GEN_7 = {io_addrIn[127:29], io_addrIn[28:12] ^ 17'h10020};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [99:0]     _GEN_8 = {io_addrIn[127:32], io_addrIn[31:28] ^ 4'h8};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire            io_rdLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            io_wrLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
