...
module DigitalTop(	// @[generators/chipyard/src/main/scala/DigitalTop.scala:44:7]
  ...
  wire        _fft_domain_auto_fragmenter_anon_in_a_ready;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  wire        _fft_domain_auto_fragmenter_anon_in_d_valid;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  wire [2:0]  _fft_domain_auto_fragmenter_anon_in_d_bits_opcode;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  wire [2:0]  _fft_domain_auto_fragmenter_anon_in_d_bits_size;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  wire [6:0]  _fft_domain_auto_fragmenter_anon_in_d_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  wire [63:0] _fft_domain_auto_fragmenter_anon_in_d_bits_data;	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  ...
  wire        _pbus_auto_coupler_to_tailWrite_tl_out_a_valid;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [2:0]  _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_opcode;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [2:0]  _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_param;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [2:0]  _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_size;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [6:0]  _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_source;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [13:0] _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_address;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [7:0]  _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_mask;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire [63:0] _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_data;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire        _pbus_auto_coupler_to_tailWrite_tl_out_a_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  wire        _pbus_auto_coupler_to_tailWrite_tl_out_d_ready;	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
  ...
  PeripheryBus_pbus pbus (	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    ...
    .auto_coupler_to_tailWrite_tl_out_a_ready                            (_fft_domain_auto_fragmenter_anon_in_a_ready),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_coupler_to_tailWrite_tl_out_a_valid                            (_pbus_auto_coupler_to_tailWrite_tl_out_a_valid),
    .auto_coupler_to_tailWrite_tl_out_a_bits_opcode                      (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_opcode),
    .auto_coupler_to_tailWrite_tl_out_a_bits_param                       (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_param),
    .auto_coupler_to_tailWrite_tl_out_a_bits_size                        (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_size),
    .auto_coupler_to_tailWrite_tl_out_a_bits_source                      (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_source),
    .auto_coupler_to_tailWrite_tl_out_a_bits_address                     (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_address),
    .auto_coupler_to_tailWrite_tl_out_a_bits_mask                        (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_mask),
    .auto_coupler_to_tailWrite_tl_out_a_bits_data                        (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_data),
    .auto_coupler_to_tailWrite_tl_out_a_bits_corrupt                     (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_corrupt),
    .auto_coupler_to_tailWrite_tl_out_d_ready                            (_pbus_auto_coupler_to_tailWrite_tl_out_d_ready),
    .auto_coupler_to_tailWrite_tl_out_d_valid                            (_fft_domain_auto_fragmenter_anon_in_d_valid),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_coupler_to_tailWrite_tl_out_d_bits_opcode                      (_fft_domain_auto_fragmenter_anon_in_d_bits_opcode),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_coupler_to_tailWrite_tl_out_d_bits_size                        (_fft_domain_auto_fragmenter_anon_in_d_bits_size),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_coupler_to_tailWrite_tl_out_d_bits_source                      (_fft_domain_auto_fragmenter_anon_in_d_bits_source),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_coupler_to_tailWrite_tl_out_d_bits_data                        (_fft_domain_auto_fragmenter_anon_in_d_bits_data),	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
  ...
  ClockSinkDomain_1 fft_domain (	// @[generators/rocket-chip/src/main/scala/tilelink/BusWrapper.scala:89:28]
    .auto_fragmenter_anon_in_a_ready        (_fft_domain_auto_fragmenter_anon_in_a_ready),
    .auto_fragmenter_anon_in_a_valid        (_pbus_auto_coupler_to_tailWrite_tl_out_a_valid),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_opcode  (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_opcode),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_param   (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_param),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_size    (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_size),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_source  (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_source),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_address (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_address),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_mask    (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_mask),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_data    (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_data),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_a_bits_corrupt (_pbus_auto_coupler_to_tailWrite_tl_out_a_bits_corrupt),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_d_ready        (_pbus_auto_coupler_to_tailWrite_tl_out_d_ready),	// @[generators/rocket-chip/src/main/scala/subsystem/PeripheryBus.scala:37:26]
    .auto_fragmenter_anon_in_d_valid        (_fft_domain_auto_fragmenter_anon_in_d_valid),
    .auto_fragmenter_anon_in_d_bits_opcode  (_fft_domain_auto_fragmenter_anon_in_d_bits_opcode),
    .auto_fragmenter_anon_in_d_bits_size    (_fft_domain_auto_fragmenter_anon_in_d_bits_size),
    .auto_fragmenter_anon_in_d_bits_source  (_fft_domain_auto_fragmenter_anon_in_d_bits_source),
    .auto_fragmenter_anon_in_d_bits_data    (_fft_domain_auto_fragmenter_anon_in_d_bits_data),
