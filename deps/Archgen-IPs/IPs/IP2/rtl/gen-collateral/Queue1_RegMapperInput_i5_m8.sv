...
module Queue1_RegMapperInput_i5_m8(	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
  ...
  input  [4:0]  io_enq_bits_index,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [4:0]  io_deq_bits_index,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32]
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2][27:0]};	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_index = ram[5:1];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_data = ram[69:6];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_mask = ram[77:70];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_extra_tlrr_extra_source = ram[88:78];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
  assign io_deq_bits_extra_tlrr_extra_size = ram[90:89];	// @[generators/rocket-chip/src/main/scala/regmapper/RegMapper.scala:71:32, src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
