...
module Queue1_TLBundleA_a26d64s14k1z2u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [13:0] io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [13:0] io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  reg  [120:0] ram;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][25:0]};	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_source = ram[21:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = ram[47:22];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = ram[55:48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = ram[119:56];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = ram[120];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
