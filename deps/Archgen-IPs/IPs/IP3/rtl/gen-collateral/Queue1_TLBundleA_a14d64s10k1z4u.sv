...
module Queue1_TLBundleA_a14d64s10k1z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  assign io_deq_bits_source = ram[19:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
