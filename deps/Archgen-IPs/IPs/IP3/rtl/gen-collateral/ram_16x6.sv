...
module ram_16x6(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [3:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [5:0] R0_data,
  ...
  reg [5:0] Memory[0:15];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [4:0] i = 5'h0; i < 5'h10; i += 5'h1) begin
          ...
          Memory[i[3:0]] = _RANDOM_MEM[5:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
