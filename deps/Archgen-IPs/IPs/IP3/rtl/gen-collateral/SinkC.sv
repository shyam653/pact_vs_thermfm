...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  wire [1:0]  _GEN = {1'h0, io_rel_pop_bits_index[0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:161:{43,65}]
  wire [1:0]  _io_rel_pop_ready_T_1 = _putbuffer_io_valid >> _GEN;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27, :161:43]
  ...
  Queue2_TLBundleC_a32d64s9k3z3c c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
