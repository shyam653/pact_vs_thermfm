...
module Queue2_AXI4BundleAW(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x65 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({14'h1, io_enq_bits_size, io_enq_bits_len, io_enq_bits_addr, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[39:8];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_len = _ram_ext_R0_data[47:40];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_size = _ram_ext_R0_data[50:48];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_burst = _ram_ext_R0_data[52:51];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_lock = _ram_ext_R0_data[53];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_cache = _ram_ext_R0_data[57:54];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_prot = _ram_ext_R0_data[60:58];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_qos = _ram_ext_R0_data[64:61];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
