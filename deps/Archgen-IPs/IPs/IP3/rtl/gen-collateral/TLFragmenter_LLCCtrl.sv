...
module TLFragmenter_LLCCtrl(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  TLMonitor_32 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[13:4]),	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
  ...
  Repeater_TLBundleA_a26d64s10k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
