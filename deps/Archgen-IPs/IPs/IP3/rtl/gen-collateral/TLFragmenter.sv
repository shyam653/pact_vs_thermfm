...
module TLFragmenter(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  output [14:0] auto_anon_out_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [14:0] auto_anon_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  TLMonitor_14 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[14:5]),	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
    .io_in_d_bits_sink    (auto_anon_out_d_bits_sink),
    .io_in_d_bits_denied  (d_denied),	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:243:48]
    .io_in_d_bits_corrupt (auto_anon_out_d_bits_corrupt)
  );	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
  Repeater_TLBundleA_a29d32s10k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock                                 (clock),
    .reset                                 (reset),
  ...
  assign auto_anon_in_d_bits_source = auto_anon_out_d_bits_source[14:5];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :238:47]
  ...
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[28:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:2]), 2'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:244:{71,76}]
