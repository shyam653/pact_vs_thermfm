...
module SourceB(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
  ...
  wire [1:0]  _GEN = {~(todo[0]), 1'h1} & todo;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7, :52:19, :53:{16,37}]
  `ifndef SYNTHESIS	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:12]
    always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:12]
      if (~reset & {~io_req_valid, io_req_bits_clients} == 3'h0) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:59:{12,13,27,50}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
    if (reset)	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
      ...
      remain <= (remain | (_param_T_1 ? io_req_bits_clients : 2'h0)) & ~(io_b_ready & b_valid ? _GEN : 2'h0);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:46:25, :47:30, :48:30, :49:{23,37,39}, :53:37, :62:{24,37}, :68:21, :69:{19,32}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7]
        ...
        remain = _RANDOM[/*Zero width*/ 1'b0][1:0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7, :46:25]
        tag_r = _RANDOM[/*Zero width*/ 1'b0][14:2];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7, :46:25, :72:52]
  ...
  assign io_b_bits_source = (_GEN[0] ? 9'h124 : 9'h0) | (_GEN[1] ? 9'h120 : 9'h0);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SourceB.scala:33:7, :53:37, src/main/scala/chisel3/util/Mux.scala:30:73, :32:36]
