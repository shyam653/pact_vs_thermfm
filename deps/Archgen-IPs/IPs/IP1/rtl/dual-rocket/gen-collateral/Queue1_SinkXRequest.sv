...
module Queue1_SinkXRequest(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      ram <= {io_enq_bits_invalidate, io_enq_bits_address};	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_address = ram[31:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_invalidate = ram[32];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
